            ...
            var KTKanbanBoardDemo = function() {
                var _demo4 = function() {
                    var kanban = new jKanban({
                        ...
                        boards: [{
                                'id': '_backlog',
                                'title': '<div class="kanban-title">Kalibrasi A</div>',
                                'class': 'white',
                                'item': [{
                                        'title': `
                                        <div class="d-flex align-items-center">
                                    ...
                                    },
                                    {
                                        'title': `
                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column align-items-start">
                                                        <span class="text-dark font-weight-bolder">Surya Saputra <a href="{{route('detail_info')}}"><i class="flaticon-more"></i></a></span>
                                                        <span class="text-dark font-weight-bold">2198998</span>
                                                        <span class="text-dark font-weight-bold ">Nilai <span class="text-dark font-weight-boldest">100.03</span></span>
                                                    </div>
                                                </div>
                                ...
                                'item': [{
                                        'title': `
                                            <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex flex-column align-items-start">
                                                        <span class="text-dark font-weight-bolder">Surya Saputra <a href="" onclicked="redirectTo()"><i class="flaticon-more"></i></a></span>
                                                        <span class="text-dark font-weight-bold">2198998</span>
                                                        <span class="text-dark font-weight-bold ">Nilai <span class="text-dark font-weight-boldest">100.03</span></span>
                                                    </div>
                                                </div>

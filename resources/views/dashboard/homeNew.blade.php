																		...
																		<div class="navi-item my-2">
																			<a href="{{ route('dashboard_absen') }}" class="navi-link px-0">
																				<span class="navi-icon mr-4">
																					<span class="svg-icon svg-icon-lg">
																						<!--begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-heart.svg-->
																						<img src="assets/media/logos/icon_absenceManagement.png" alt="HPK" width="50px">
																						<!--end::Svg Icon-->
																					</span>
																				</span>
																				<div class="navi-text">
												...
												<div class="card-body pt-1">
													<div class="row">
														<div class="col-md-6 col-lg-6 col-xs-12">
															<div class="card card-custom bgi-repeat-y  card-stretch gutter-b" style=" background-image: url('../../assets/media/logos/Banner_TA.png'); background-size: cover">
																<!--begin::Body-->
																...
																<div class="card-footer" style="border:0px;">
																	<div class="row">
																		<div class="col-sm-12 mb-3">
																			<a href="" target="_blank" class="btn btn-sm btn-light font-weight-bold float-right text-dark">Lihat Detail</a>
																		</div>
																	</div>
																</div>
																<!--end::Body-->
														...
														<div class="col-md-6 col-lg-6 col-xs-12">
															<div class="card card-custom bgi-repeat-y  card-stretch gutter-b" style=" background-image: url('../../assets/media/logos/Banner_LXP.png'); background-size: cover">
																<!--begin::Body-->
																<div class="card-body d-flex align-items-center">
																	<div class="row">
																		<div class="col-sm-2 mt-3">
																		...
																		<div class="col-sm-10">
																			<h3 style="font-size: 25px;" class="text-white font-weight-bolder line-height-lg mb-1">Learning Experince Platform</h3>
																			<p style="color:white">Tingkatkan Pengetahuan dan Skil</p>
																		</div>
																	</div>
																</div>
																<div class="card-footer" style="border:0px;">

                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    {{-- <div class="form_tipeCuti" style="display: none"> --}}
                                                        <div class="form-group"id="select_cuti">
                                                            ...
                                                            <select class="form-control selectpicker" id="nama_tipe_cuti">
                                                                {{-- <option label="Label"></option> --}}
...
<script>
	...
	// 			$('#id_saldo_cuti').val(arr.id_saldo);
	// 			// $('#kt_select2_6').val(arr.nama_kegiatan);
    ...
    //             var tipe_cuti_id = $('#tipe_cuti_id').val()
    //             var saldo = $('#saldo')
    ...
    <script>
        ...
        function formatRepoSelection12(repo1) {
            if (repo.text == '') {
                return repo.nik;
            } else {
                return repo.text;

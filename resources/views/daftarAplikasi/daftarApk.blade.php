...
<body id="kt_body" class="page-loading-enabled quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-minimize-hoverable aside-fixed">
    <script>
        document.title = 'Daftar Aplikasi | PI-Smart'
    </script>
    <!--begin::Main-->
    <!--begin::Header Mobile-->
                    ...
                    <div class="subheader py-2 subheader-solid" id="kt_subheader">
                        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                            ...
                            <div class="d-flex align-items-center flex-wrap mr-1">
                                <!--begin::Page Title-->
                                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Daftar Aplikasi</h5>
                                <!--end::Page Title-->
                            </div>
                            <!--end::Info-->
                        </div>
                                ...
                                <div class="container gutter-b">
                                    <div class="row">
                                        <div class="col-lg-4 mb-5">
                                            <!--begin::Callout-->
                                            <a href="#" class="card card-custom-new mb-8 mb-lg-0 shadow-sm wave">
                                        ...
                                        <div class="col-lg-4 mb-5">
                                            <!--begin::Callout-->
                                            <a href="{{ route('tjsl') }}" class="card card-custom-new mb-8 mb-lg-0 shadow-sm wave">
                                                <div class="card-body px-0">
                                                    <div class="d-flex align-items-center p-6">
                                                        <!--begin::Icon-->
                                                        <div class="mr-6">
                                                            <span class="svg-icon svg-icon-primary svg-icon-4x">
                                                                <img src="assets/media/logos/icon_tjsl.png" alt="TJSL" width="50px">
                                                            </span>
                                                        </div>
                                                        <!--end::Icon-->
                                                        <!--begin::Content-->

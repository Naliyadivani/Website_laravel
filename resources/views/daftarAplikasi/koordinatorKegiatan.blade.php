...
@section('kontenpage') 
	...
	<body id="kt_body" class="page-loading-enabled quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-minimize-hoverable aside-fixed">
		<script>
			document.title='Laporan Kegiatan | PI-Smart'
		</script>
		<!--begin::Main-->
		<!--begin::Header Mobile-->
						...
						<div class="subheader py-2 subheader-solid" id="kt_subheader">
							<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-1">
									<!--begin::Page Title-->
									<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Koordinator Kegiatan</h5>
									<!--end::Page Title-->
								</div>
								<!--end::Info-->
                                ...
                                <div class="card card-custom">
                                    <div class="card-header justify-content-center">
										<div class="card-title">
											<h3 class="card-label font-weight-bold">
												Tambah Koordinator Kegiatan
											</h3>
										</div>
									</div>
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" data-live-search="true" onchange="jenisKegiatan(this)" title="Pilih Salah Satu">
                                                        <option value="Kegiatan Tanggung Jawab Sosial dan Lingkungan (TJSL) perusahaan">Kegiatan Tanggung Jawab Sosial dan Lingkungan (TJSL) perusahaan</option>
                                                        <option value="Kegiatan sosial kemasyarakatan diluar perusahaan">Kegiatan sosial kemasyarakatan diluar perusahaan</option>
                                                    </select>
                                                </div>
                                                
												<div id="form_koordinator" style="display: none">
													<div class="form-group select_kegiatan" id="select_kegiatan" style="display: none;">
														<label>Pilih Kegiatan <span class="text-muted">(Opsional)</span></label>
														<select class="form-control selectpicker" data-live-search="true" title="Pilih Salah Satu" id="nama_kegiatan">
														</select>
													</div>
												
                                                <div class="form-group" id="text_kegiatan">
                                                    <label>Nama Kegiatan</label>
                                                  <input class="form-control" type="text" id="nama_sub_kegiatan">
                                                </div>

                                                <div class="table-responsive">
                                                    <label>List Peserta</label>
                                                  <table class="table table-bordered table-hover table-vertical-center table-striped text-center">
                                                    <thead>
														<tr>
															<th>No</th>
															<th>NIK</th>
															<th>Nama</th>
															<th><button class="btn btn-primary" data-toggle="modal" data-target="modalPeserta">Tambah Peserta</button></th>
														</tr>
                                                    </thead>
												...
												<div class="form-group">
													<label class="checkbox">
														<input type="checkbox" name="Checkboxes1" id="Checkboxes1">
														<span class="mr-3"></span>
														<b>
															Dengan ini menyatakan bahwa data yang saya kirim adalah benar dan dapat dipertanggungjawabkan
														</b>
													</label>
												</div>
			...
			<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						...
						<button type="button" class="close" data-dismis="modal" onclick="" aria-label="Close">
					...
					<div class="modal-body">
						<div id="page">
							<div class="p2">
								<input type="hidden" id="id_koordinator">
								<div class="form-group">
									<label for="cariPeserta">Cari Peserta</label>
									<select class="form-control selectpicker" data-live-search="true" title="Masukkan Nama atau Nomor Pegawai">
									<span class="select2-dropdown select2-dropdown--below" dir="ltr" style="width: 458px;">
									</select>
								</div>
								...
								{{-- <div class="form-group">
									...
									<select class="form-control employee select2-hidden-accessible" style="width: 100% !important" data-select2-id="1" tabindex="-1" aria-hidden="true">
									</select>
										<span class="select2 select2-container select2-container--default select2-container--below select2-container--open select2-container--focus" dir="ltr" data-select2-id="2" style="width: 100%;">
											<span class="selection">
												<span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="true" tabindex="0" aria-disabled="false" aria-labelledby="select2-ftxx-container" aria-owns="select2-ftxx-results">
													<span class="select2-selection__rendered" id="select2-ftxx-container" role="textbox" aria-readonly="true">
														<span class="select2-selection__placeholder">Masukkan Nama atau Nomor Pegawai</span>
												</span>
										...
										<span class="select2-search select2-search--dropdown">
											<input class="select2-search__field" type="search" tabindex="0" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" aria-controls="select2-ftxx-results">
										</span>
										<span class="select2-results">
											<ul class="select2-results__options" role="listbox" id="select2-ftxx-results" aria-expanded="true" aria-hidden="false">
												<li role="alert" aria-live="assertive" class="select2-results__option select2-results__message">Please enter 4 or more characters
													</li>
												</ul>
											</span>
										</span>
								...
								<div class="modal-footer">
									<button type="button" class="btn btn-light-primary font-weight-bold" data-dismis="modal">Close</button>
									<button type="button" class="btn btn-primary font-weight-bold" data-dismis="modal">Save</button>
								</div>
							</div>
						</div>
					</div>
        ...
        {{-- <script>
            ...
            function tipeKegiatan(selectElement){
                var selectedValue = selectElement.value;
                console.log("Nilai yang dipilih: "+ selectedValue);
            }
		...
		<script>
			...
			function jenisKegiatan(val){
				$('#form_koordinator').show();
				var jenis = 'Kegiatan sosial kemasyarakatan diluar perusahaan';
				if(val.value == jenis){
					$('#select_kegiatan').hide();
					$('#pilih_kegiatan').show();
					
				}
				else{
					$('#select_kegiatan').show();
					$('#text_kegiatan').show();
				}
			}
		</script>

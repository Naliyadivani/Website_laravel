                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control form-control-solid"  value="{{ Auth::user()->nik }}" id="nik" placeholder="NIK" readonly>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Nama</label>
                                                        <input type="text" class="form-control form-control-solid" value="{{ Auth::user()->name }}" id="nama" placeholder="Nama" readonly>
                                                    </div>
                                                </div>
                                                
                                                <div class="form-group">
                                                    <label>Unit Kerja</label>
                                                    <input type="text" class="form-control" disabled="disabled" value="" id="unit_kerja" placeholder="Unit Kerja">
                                                </div>

                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" disabled="disabled" value="" id="nik" placeholder="NIK">
                                                    </div>
                                                </div>    
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        <label>Nama</label>
                                                        <input type="text" class="form-control" disabled="disabled" value="" id="nama" placeholder="Nama">
                                                    </div>
                                                </div>
														...
														<div class="card-body">
															<div class="form-group row">
																...
																<div class="col-6 text-right">
																	<a href="#" class="btn btn-primary btn-sm">Tambah Koordinator</a>
																</div>

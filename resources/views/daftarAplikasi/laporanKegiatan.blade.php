...
<body id="kt_body" class="page-loading-enabled quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-minimize-hoverable aside-fixed">
							...
							<div class="dropdown">
								...
								<div class="topbar-item" data-toggle="dropdown" data-offset="0px,0px" aria-expanded="false">
									<div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2">
										...
										<span id="user_acc" class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{ $user['user_name'] }}</span>
									</div>
								</div>
				...
				<div class="subheader py-2 subheader-solid" id="kt_subheader">
					<div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
						...
						<div class="d-flex align-items-center flex-wrap mr-1">
							<!--begin::Page Title-->
							<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Tambah Laporan Kegiatan</h5>
							<!--end::Page Title-->
						</div>
						<!--end::Info-->
							...
							<div class="card-header justify-content-center">
								<div class="card-title">
									<h3 class="card-label font-weight-bold">
										Laporan Keterlibatan Karyawan dalam Kegiatan Sosial Kemasyarakatan
									</h3>
								</div>
							</div>
							<div class="card-body">
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label>NIK</label>
											{{-- pakai readonly untuk mengambil Nik, nama, unit kerja --}}
											<input type="text" class="form-control form-control-solid" value="{{ $user['nik'] }}" id="nik" placeholder="NIK" readonly>
									...
									<div class="col-lg-6">
										<div class="form-group">
											<label>Nama</label>
											<input type="text" class="form-control form-control-solid" value="{{ $user['user_name'] }}" id="nama" placeholder="Nama" readonly>
										</div>
									</div>

									<div class="form-group">
										<label>Unit Kerja</label>
										<input type="text" class="form-control form-control-solid" value="{{$user['user_dept_name']}}" id="unit_kerja" placeholder="Unit Kerja" readonly>
									</div>
									...
									<div class="form-group">
										...
										<select class="form-control selectpicker" data-live-search="true" onchange="tipeKegiatan(this)" title="Pilih Salah Satu">
											<option value="Individu">Individu</option>
											<option value="Group">Group</option>
										</select>
									</div>

									<div id="form_kegiatan" style="display: none">
										<div class="form-group select_kegiatan" id="select_kegiatan" style="display: none;">
											<label>Pilih Kegiatan <span style="color:red">*</span></label>
											<select class="form-control selectpicker" data-live-search="true" title="Pilih Salah Satu" id="pilih_kegiatan">
											</select>
										</div>

										<div class="card card-custom card-fit card-border bg-secondary-o-85" style="display:none" id="div_koordinator_kegiatan">
											<div class="card-body">
												<div class="form-group row">
													<div class="col-6">
														<label>Koodinator Kegiatan</label>
													</div>
													<div class="col-6 text-right">
														<a href="{{ route('koordinator_kegiatan') }}" class="btn btn-primary btn-sm">Tambah Koordinator</a>
													</div>
													<select class="form-control selectpicker col-12 mt-2" data-live-search="true" title="Pilih Salah Satu" id="koordinator_kegiatan">
													</select>
												</div>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" id="text_kegiatan">
										</div>

										<div class="form-group">
											<label>Tanggal Kegiatan <span class="text-danger">*</span></label>
											<div class="input-group date" id="start_date" data-target-input="nearest">
												<input type="text" class="form-control datetimepicker-input" readonly data-toggle="datetimepicker" placeholder="Start date" name="start_date" id="tanggal_kegiatan" data-target="#start_date" />
										...
										{{-- <div class="form-group">
                                                    <label>Tanggal Kegiatan<span class="text-danger">*</span></label>
                                                     <div class="input-group date" id="start_date" data-target-input="nearest">
                                                      <input type="text" id="tanggal_kegiatan" class="form-control datetimepicker-input" data-toggle="datetimepicker" name="start_date" placeholder="Select date & time" data-target="#start_date"/>
                                                        <div class="input-group-append">
										...
										<div class="form-group">
											...
											<input class="form-control" type="text" id="lokasi_kegiatan">
										</div>
										...
										<div class="form-group">
											<label class="checkbox" onclick="btnCondition()">
									...
									<div class="card-footer text-right">
										<button class="btn btn-outline-danger font-weight-bold">Save As Draft</button>
	...
	<script>
		...
		function tipeKegiatan(val) {
			$('#form_kegiatan').show()
			if (val.value == 'Individu') {
				$('#div_koordinator_kegiatan').hide();
				$('#koordinator_kegiatan').val(null).selectpicker('refresh');
			} else {
				$('#div_koordinator_kegiatan').show();
			}
		}
		...
		function btnCondition() {
			var check = $('#Checkboxes1').is(':checked')
			if (check == true) {
